...
#define SHKMyAppName			@"Putt Putt Caddy"
#define SHKMyAppURL				@"http://caddy.shawnsbits.com"
...
#define SHKFacebookKey				@"edc93e1578b13c6a34fe6fe40f481446"
#define SHKFacebookSecret			@"be21304b2815e5d7018edaa8b75113aa"
 ...
 */
#define SHKTwitterConsumerKey		@"OfViluGdTZ37IqpB0mKQ"
#define SHKTwitterSecret			@"6uHwDkTTVJeg0OCM8Jx3DTWzg8e7026CZd2lUvP9Rg"
#define SHKTwitterCallbackUrl		@"http://caddy.shawnsbits.com/iphone" // You need to set this if using OAuth, see note above (xAuth users can skip it)
