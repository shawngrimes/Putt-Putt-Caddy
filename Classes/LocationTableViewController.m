...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
	[self.tableView.dataSource tableView:tableView didSelectRowAtIndexPath:indexPath];
	/*
	if(indexPath.row<[self.tableView.dataSource count]){
		...
		locDetailsVC.pbResult=[self.tableView.dataSource objectAtIndex:indexPath.row];
